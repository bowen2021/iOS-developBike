...
@interface XSDashboardProgressLayer : CALayer
...
@property(nonatomic, assign)CGFloat blockAngle;     //每个进度快的角度
@property(nonatomic, assign)CGFloat gapAngle;       //两个进度块间隙的角度
